# Source : https://github.com/maxmalysh/python-proxy-checker/blob/master/proxy.py
...
out_filename = 'valid_proxy.txt'
test_url = "https://f-droid.org"
thread_number = 10000
timeout_value = 5
...
class ProcessThread(threading.Thread):
    ...
    def process(self, task):
        proxy = task
        log_msg = str("Thread #%3d.  Trying HTTPS proxy %21s \t\t" % (self.id, proxy))
